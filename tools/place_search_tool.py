import os
from utils.palce import GooglePlaceSearchTool, TavilyPlaceSearchTool, SerpapiPlaceSearchTool
...
class PlaceSearchTool:
    def __init__(self):
        ...
        self.serpapi_search = SerpapiPlaceSearchTool()
    ...
    def _setup_tools(self) -> List:
        ...
        def search_attractions(place:str) -> str:
            ...
            try: 
                ...
                attraction_result = self.serpapi_search.Serpapi_search_attractions(place)
                if attraction_result:
                    return f"Following are the attraction after  google search results of {place} as suggested by google: {attraction_result}"
            except:
        ...
        def search_restaurants(place:str) -> str:
            ...
            try:
                ...
                restaurants_result = self.serpapi_search.Serpapi_search_restaurants(place)
                if restaurants_result:
                    return f"Following are the restaurants of {place} as suggested by google: {restaurants_result}"
        ...
        def search_activities(place:str) -> str:
            ...
            try:
                ...
                restaurants_result = self.serpapi_search.Serpapi_search_activity(place)
                if restaurants_result:
                    return f"Following are the activities in and around {place} as suggested by google: {restaurants_result}"
            except Exception as e:
        ...
        return [search_attractions, search_restaurants, search_activities]
